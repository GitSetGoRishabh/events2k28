...
<section class="ftco-section contact-section ftco-degree-bg">
      ...
      <div class="col-md-8" id="signup_msg">
        ...
        <div class="row block-9">
          ...
          <div class="col-md-6">
            <div class="media block-6 services d-block text-center p-4" style="background: #1a2128; border-radius: 20px;">
              <h3 class="mb-3" style="color: #fff;">Why Register?</h3>
              <p style="color: #d9d9d9; text-align: left;">- Secure your spot in your chosen event quickly.<br>- Get event updates and reminders by email.<br>- Access exclusive benefits and priority seating.<br>- Connect with top competitors and organizers.</p>
              <p style="color: #9aa1ad;">Already have a booking? Contact support at <a href="mailto:support@gmail.com" style="color: #f59">support@gmail.com</a>.</p>
            </div>
          </div>
        </div>
      </div>
